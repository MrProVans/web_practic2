const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./weather-Dhq2rcfG.js","./weather-CqWnZsKF.css","./movies-Du1PJPM6.js","./movies-CYRgnBZM.css","./currency-DEZ9MOKE.js","./currency-Cn_DXAXt.css"])))=>i.map(i=>d[i]);
(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))i(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function s(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(a){if(a.ep)return;a.ep=!0;const n=s(a);fetch(a.href,n)}})();const A="modulepreload",S=function(t,e){return new URL(t,e).href},E={},b=function(e,s,i){let a=Promise.resolve();if(s&&s.length>0){let P=function(o){return Promise.all(o.map(d=>Promise.resolve(d).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};const r=document.getElementsByTagName("link"),c=document.querySelector("meta[property=csp-nonce]"),y=c?.nonce||c?.getAttribute("nonce");a=P(s.map(o=>{if(o=S(o,i),o in E)return;E[o]=!0;const d=o.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(i)for(let v=r.length-1;v>=0;v--){const p=r[v];if(p.href===o&&(!d||p.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${o}"]${u}`))return;const l=document.createElement("link");if(l.rel=d?"stylesheet":A,d||(l.as="script"),l.crossOrigin="",l.href=o,y&&l.setAttribute("nonce",y),document.head.appendChild(l),d)return new Promise((v,p)=>{l.addEventListener("load",v),l.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${o}`)))})}))}function n(r){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=r,window.dispatchEvent(c),!c.defaultPrevented)throw r}return a.then(r=>{for(const c of r||[])c.status==="rejected"&&n(c.reason);return e().catch(n)})},I=()=>`
    <header class="header">
      <div class="container">
  ...
  `;_.init=()=>{document.addEventListener("click",t=>{const e=t.target.closest(".feature-card, .floating-card");if(e){const s=e.closest("[data-page]")?.getAttribute("data-page");if(s){const i=new Event("click",{bubbles:!0}),a=document.querySelector(`.nav-link[data-page="${s}"]`);a&&a.dispatchEvent(i)}}})};let h,m,f;try{h=(await b(async()=>{const{default:t}=await import("./weather-Dhq2rcfG.js");return{default:t}},__vite__mapDeps([0,1]),import.meta.url)).default}catch{h=null}try{m=(await b(async()=>{const{default:t}=await import("./movies-Du1PJPM6.js");return{default:t}},__vite__mapDeps([2,3]),import.meta.url)).default}catch{m=null}try{f=(await b(async()=>{const{default:t}=await import("./currency-DEZ9MOKE.js");return{default:t}},__vite__mapDeps([4,5]),import.meta.url)).default}catch{f=null}class T{constructor(){this.app=document.getElementById("app"),this.currentPage="home",this.pages={home:_,weather:h,movies:m,currency:f},this.init()}init(){this.hideLoading(),this.render(),this.setupNavigation()}hideLoading(){const e=document.getElementById("loading");e&&(e.style.display="none")}render(){this.app.innerHTML=`
            ${I()}
